# 3 different networks: V, Q, policy
# V takes states, outputs scalar value
# Critic takes states and actions, outputs scalar value
# Actor takes states, outputs mean and sigma
# Constrain sigma w/ clamp (0,1) or sigmoid
...
class ActorNetwork(nn.Module):
    def __init__(self, alpha, input_dims, fc1_dims, fc2_dims, max_action,
        ...
        self.checkpoint_dir = chkpt_dir
        self.checkpoint_file = os.path.join(self.checkpoint_dir, name+'_sac')
        self.reparam_noise = 1e-6 # hard coded
