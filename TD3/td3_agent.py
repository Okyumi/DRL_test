...
class Agent():
    def __init__(self, alpha, beta, input_dims, tau, env,
        ...
        self.time_step = 0 # handle the countdown to the end of the warm up period
        self.warmup=warmup
        ...
        self.critic_2 = CriticNetwork(beta, input_dims, layer1_size,
                                      layer2_size, n_actions=n_actions,
                                      name= 'critic_2')
        # now define the target actors and target critics
        ...
        # we need a parameter for our noise for action exploration
        self.noise = noise
    ...
    def update_network_parameters(self, tau=None):
        ...
        for name in critic_1_dict:
            critic_1_dict[name] = tau*critic_1_dict[name].clone() + (1-tau)*target_critic_1_dict[name].clone()
        
        for name in critic_2_dict:
            critic_2_dict[name] = tau*critic_2_dict[name].clone() + (1-tau)*target_critic_2_dict[name].clone()
